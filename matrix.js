...
function initMatrixResult() {
    ...
    function drawExtra(angleIdx, offX, offY, val, letter, lOffX, lOffY, col, dol, hrt) {
        ...
        if (dol) {
            ...
            d.setAttribute("x", x - (isMobile ? 45 : 30)); d.setAttribute("y", y - (isMobile ? 35 : 30));
        ...
        if (hrt) {
            ...
            path.setAttribute("d", `M ${hx} ${hy} c ${-5 * hScale} ${-5 * hScale}, ${-15 * hScale} 0, ${-10 * hScale} ${10 * hScale} c ${5 * hScale} ${10 * hScale}, ${15 * hScale} ${10 * hScale}, ${20 * hScale} 0 c ${5 * hScale} ${-10 * hScale}, ${-5 * hScale} ${-15 * hScale}, ${-10 * hScale} ${-10 * hScale} Z`);
            path.setAttribute("fill", "#e84e42"); path.setAttribute("stroke", "#000");
            nodeLayer.appendChild(path);
        }
    }
    drawExtra(5, (isMobile ? 20 : 10), (isMobile ? 20 : 10), innerA, "К", (isMobile ? -18 : -13), (isMobile ? -18 : -13), "#fff", false, false);
    drawExtra(5, (isMobile ? 100 : 80), (isMobile ? 20 : 10), innerB, "О", (isMobile ? -18 : -13), (isMobile ? -18 : -13), "#fff", true, false);
    drawExtra(5, (isMobile ? 20 : 10), (isMobile ? 100 : 80), innerC, "Н", (isMobile ? -18 : -18), (isMobile ? -18 : -13), "#fff", false, true);
    ...
    drawOuterMarker(6, "Г", "60 лет", 0, (isMobile ? 42.5 * zoom : 35 * zoom), "start", 15, 2);
